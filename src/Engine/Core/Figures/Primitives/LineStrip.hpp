...
namespace ge {
    ...
    public:
        LineStrip(const std::shared_ptr<Vector2i>& scene, std::size_t vertices, const Color& color) noexcept;
        LineStrip(const std::shared_ptr<Vector2i>& scene, std::size_t vertices) noexcept;
