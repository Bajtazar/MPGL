...
namespace ge {
    ...
    public:
        ...
        pointer& operator[] (std::size_t index) noexcept
            { return storage[index]; }
        pointer const& operator[] (std::size_t index) const noexcept
            { return storage[index]; }
    ...
    template <Event T, typename... Args, void(T::*EventMethod)(Args...)>
    void UniversalRegister<T, void(T::*)(Args...), EventMethod>::onEvent(
        Args&&... args) noexcept
    {
