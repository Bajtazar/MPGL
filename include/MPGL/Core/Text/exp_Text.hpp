...
#include <MPGL/Core/Text/exp_GlyphSprite.hpp>
...
namespace mpgl::exp {
    ...
    private:
        ...
        private:
            ...
            typedef std::array<Vector,
                Dim::orhogonal_space_degree>        Versors;
...
#include <MPGL/Core/Text/exp_Text.ipp>
#include <MPGL/Core/Text/exp_Text.tpp>
