...
namespace mpgl {
    ...
    namespace kernels {
        ...
        /// The gaussian blur
        inline constexpr const Matrix3f gaussian {
        ...
        /// The mean filter
        inline constexpr const Matrix3f mean {
        ...
        inline constexpr const Matrix3f laplacian {
        ...
        /// The embos filter
        inline constexpr const Matrix3f embos {
        ...
        inline constexpr const Matrix3f sharpness {
