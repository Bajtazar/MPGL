...
namespace mpgl {
    ...
    /**
     * Base class for classes that are notified when key is released
     */
    class KeyReleaseEvent : public virtual EventBase {
    public:
    ...
    protected:
        KeyReleaseEvent(KeyReleaseEvent const&) noexcept = default;
