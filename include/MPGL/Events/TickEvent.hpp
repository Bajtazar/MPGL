...
namespace mpgl {
    ...
    public:
        ...
        TickEvent& operator=(TickEvent const&) = delete;
        ...
        /**
         * Virtual destructor. Destroys the Tick Event object
         */
        virtual ~TickEvent(void) noexcept = default;
    protected:
        TickEvent(TickEvent const&) noexcept = default;
        TickEvent(TickEvent&&) noexcept = default;
    };
