...
namespace mpgl {
    ...
    /**
     * Reverses the order of the bits in the unsigned integer
     */
    class BitReversion {
    public:
         ...
         * Reverses the order of the bits in the unsigned integer
         *
         * @tparam Tp the type of the integer
         * @param bits the number to revert
         * @return the reverted number
         */
        template <std::unsigned_integral Tp>
        [[nodiscard]] constexpr Tp operator() (Tp bits) const noexcept;
    private:
